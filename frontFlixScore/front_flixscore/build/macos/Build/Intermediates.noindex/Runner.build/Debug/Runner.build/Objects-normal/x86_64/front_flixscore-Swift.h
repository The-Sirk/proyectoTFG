...
#ifndef FRONT_FLIXSCORE_SWIFT_H
#define FRONT_FLIXSCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="front_flixscore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15front_flixscore11AppDelegate")
...
SWIFT_CLASS("_TtC15front_flixscore17MainFlutterWindow")
